...
jar cfm tacagent.jar AWManifest.txt com/botbox/util/*.class se/sics/tac/aw/*.class se/sics/tac/util/*.class agent/*.class agent/entertainment/*.class agent/hotel/*.class agent/logging/*.class
