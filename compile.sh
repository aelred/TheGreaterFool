...
jar cfm tacagent.jar AWManifest.txt com/botbox/util/*.class se/sics/tac/aw/*.class se/sics/tac/util/*.class agent/*.class agent/hotel/*.class agent/flight/*.class agent/entertainment/*.class
